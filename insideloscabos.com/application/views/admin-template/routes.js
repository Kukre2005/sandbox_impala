...
.config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', '$breadcrumbProvider', function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $breadcrumbProvider) {
  ...
  .state('app', {
    abstract: true,
    templateUrl: 'admin-template/common/layouts/full.html',
    ...
    resolve: {
      ...
      loadPlugin: ['$ocLazyLoad', function ($ocLazyLoad) {
        ...
        return $ocLazyLoad.load([{
          ...
          name: 'chart.js',
          files: [
            'assets/admin/bower_components/chart.js/dist/Chart.min.js',
            'assets/admin/bower_components/angular-chart.js/dist/angular-chart.min.js'
          ]
        }]);
      }],
    }
  ...
  .state('appSimple', {
    abstract: true,
    templateUrl: 'admin-template/common/layouts/simple.html',
    resolve: {
      loadPlugin: ['$ocLazyLoad', function ($ocLazyLoad) {
        // you can lazy load files for an existing module
        return $ocLazyLoad.load([{
