 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'gargsorav5-facilitator_api1.gmail.com' : 'roberto_barcenas_api1.yahoo.com.mx';
$config['APIPassword'] = $config['Sandbox'] ? '5L85XDEUC5NVMHN6' : '64DGTUPZDX4ANGAH';
$config['APISignature'] = $config['Sandbox'] ? 'ASXdDrlbTVyCpgzeV32eDNNYww9lA6ldfdO1W5xkw5T8mWp8kmmuMmze' : 'AogZYr-IfCz7j.q-c0I6Tyir2syyA-xxGUjNxxYoCsCk-Yat.MT2l874';
