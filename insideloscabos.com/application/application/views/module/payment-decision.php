	        ...
	        <div class="d-flex">
			  <ul class="list-inline mx-auto justify-content-center">
			    <li class="list-inline-item">
			    	<form role="form" action="/transportation/cardPayment" method="post" >
			    		<?php if(isset($_REQUEST['info'])){ ?>
			    		  ...
			    		  <input name="info[coupon_discount]" value="<?php echo $_REQUEST['info']['coupon_discount'] ?>" type="hidden">
			    ...
			    <li class="list-inline-item">
			    	<form role="form" action="/transportation/bookPrivate" method="post" >
			    		<?php if(isset($_REQUEST['info'])){ ?>
			    		  <input name="info[type]" value="<?php echo $_REQUEST['info']['type'] ?>" type="hidden">
			    		  <input name="info[name]" value="<?php echo $_REQUEST['info']['name'] ?>" type="hidden">
			    		  <input name="info[email]" value="<?php echo $_REQUEST['info']['email'] ?>" type="hidden">
