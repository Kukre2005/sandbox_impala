            ...
            <div class="col-md-12  col-xs-12 wow  fadeInRight " data-wow-delay=".3s">
                ...
                <div class="content-inner">
                    ...
                    <p class="">
                        ...
                        Looking for the best Los Cabos transportation? If yes, then we are here to help you with the best and the most comfortable, air-conditioned airport transportation services. At Inside Los Cabos transportation service we offer you Cabo private transportation, which will be totally yours. No delay, no sharing with strangers, no stops, and no hassles while transportation in Cabo San Lucas. You get professional chauffeurs to your Cabo hotel, condo, or private residence. Best prices & service guaranteed.!
                    </p>

                    <p class="">

                        Let our experienced, bilingual chauffeurs provide transportation to you and your party you want to be in Los Cabos. Avoid the delay of waiting for a crowded shuttle, book your ride to your hotel with us and one of our air-conditioned vehicles will be waiting for you at the airport when you arrive. Our vehicles are also available daily or hourly rates, for all of your transportation needs. Only the best airport transport services available. Private transfers, VIP first-class transportation and much more await you inside Los Cabos. Whether you are on a family trip or just traveling professionally, you can trust on our Cabo San Lucas airport transportation as we prioritize your satisfaction before anything. 
            ...
            <div class="col-md-12">
                ...
                <div class="new-comment trip-form clearfix wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <form  action="<?php echo site_url("transportation/bookPrivate") ?>" name="privateTransForm" id="privateTransForm" class="mt-30 shake" role="form" method="post" novalidate="true" class="mt-20">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <p style="color:green;" class="coupon-success-msg hide-class"></p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="form-label" for="coupon-btn">&nbsp;&nbsp;</label>

                                    <button class="btn btn-common apply-coupon-code"  main="0" type="button"><i class="fa fa-gift mr-5"></i>Apply Coupon</button>
                                    <button class="btn btn-common remove-coupon-code hide-class" type="button"><i class="fa fa-times mr-5"></i>Remove Coupon</button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Type message here" id="comments" name="info[comments]"  rows="3"  class="form-control" style="background: #e1e1e1 !important;"><?php echo (isset($info['comments'])) ? $info['comments'] : ''; ?></textarea>
                        ...
                        <img src="<?php echo base_url('assets/loader.gif'); ?>" id="loaderprivateTransForm" style="display: none"/>
        ...
        <div class="row">                
            ...
            <div class="col-md-4 wow fadeInLeft">
                ...
                <div class="inner-extra">
                    ...
                    <p class="call-toll-free"><i class="fa fa-phone mr-5"></i> +1-877-401-1796 </p>
            ...
            <div class="col-md-4 wow fadeInRight">
                ...
                <div class="inner-extra">
                    ...
                    <p>please contact us at: Toll free </p>
