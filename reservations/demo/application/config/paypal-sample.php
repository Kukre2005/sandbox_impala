 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'av45645-facilitator_api1.gmail.com' : 'roberto_barcenas_api1.yahoo.com.mx';
$config['APIPassword'] = $config['Sandbox'] ? 'Q8SLHTPVJ2A7TDSJ' : '64DGTUPZDX4ANGAH';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AmbHoBd9in2JQDAwVFjPUgK.XaQY' : 'AogZYr-IfCz7j.q-c0I6Tyir2syyA-xxGUjNxxYoCsCk-Yat.MT2l874';
