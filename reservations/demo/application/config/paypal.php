...
$config['APIUsername'] = $config['Sandbox'] ? 'info-facilitator@insideloscabos.com' : 'roberto_barcenas_api1.yahoo.com.mx';
$config['APIPassword'] = $config['Sandbox'] ? '7FYW5SWJ5LTTLS7M' : '64DGTUPZDX4ANGAH';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AJBT5kSVCpUR400CEzTscG4z4Udz' : 'AogZYr-IfCz7j.q-c0I6Tyir2syyA-xxGUjNxxYoCsCk-Yat.MT2l874';
