                ...
                <div class="new-comment trip-form clearfix wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <form  action="<?php echo site_url("transportation/bookPrivate") ?>" name="privateTransForm" id="privateTransForm" class="mt-30 shake" role="form" method="post" novalidate="true" class="mt-20">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 <?php echo IS_OFFER_HIDE; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="form-label <?php echo IS_OFFER_HIDE; ?>" for="coupon-btn">&nbsp;&nbsp;</label>

                                    <button class="btn btn-common apply-coupon-code <?php echo IS_OFFER_HIDE; ?>"  main="0" type="button"><i class="fa fa-gift mr-5"></i>Apply Coupon</button>
                                    <button class="btn btn-common remove-coupon-code hide-class <?php echo IS_OFFER_HIDE; ?>" type="button"><i class="fa fa-times mr-5"></i>Remove Coupon</button>
