...
<!--                <p>Thank You,<br>You have successfully booked - Booking Id - <?php echo $bookingId;?> hotel - <?php echo $hotelName;?> with <?php echo SITE_NAME;?>.Please check your mail for more details.</p>-->
                <p>Thank You,<br>
                You have successfully booked for <?php echo $transport_type;?>- Our confirmation system will send you an email from: info@impalacabo.com with your confirmation transportation voucher with all details, please be aware that some Antivirus send our email to the Spam!</p>
                <?php } ?>
                <div align="center">
