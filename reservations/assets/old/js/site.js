...
$(document).ready(function () {
  ...
  jQuery.validator.addMethod(
    ...
    function () {
      ...
      if (c < b || c > a) {
        console.log(
          "Total number of adults and kids must be greater than " +
            b +
      ...
      $.ajax({
        ...
        success: function (d) {
          if (d.type == 1) {
            ...
            let final_trip_cost = parseNumber(
              tripCost - discount_amount
            ).toFixed(2);
