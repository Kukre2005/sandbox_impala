app.controller('GroupsController', function ($scope,$window, $rootScope, $filter, $state,$stateParams, $location, dataFactory, localStorageService, constantData, $timeout) {
    ...
    $scope.getHotels = function (type = $scope.type) {
      var postParam = {
...
//        });
    ...
    $scope.cancelUpdate = function () {
     ...
     $scope.validationOptions = {
      ...
      messages: {
        ...
        group_typ: {
          required: "Please select the transportation type",
        },
        code: {
    ...
    $scope.addEditGroup = function (form) {
      if (form.validate()) {
        ...
        postData.type = postData.group_typ;
        $scope.isLoading = true;
        delete postData.group_typ
        console.log("postData", postData);
        
        dataFactory
          .httpRequest("/admin/hotels/addEditGroup", "POST", {}, postData)
