 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'av45645-facilitator_api1.gmail.com' : 'paypal_api1.impalacabo.com';
$config['APIPassword'] = $config['Sandbox'] ? 'Q8SLHTPVJ2A7TDSJ' : 'QHLTZFMCPRBUH7L7';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AmbHoBd9in2JQDAwVFjPUgK.XaQY' : 'AesusOdq-zCKPm2WyRH3TlMC3FArATUIsFwvXvWraMuS1mobGwZFpZA6';
