...
$config['APIUsername'] = $config['Sandbox'] ? 'info-facilitator@insideloscabos.com' : 'paypal_api1.impalacabo.com';
$config['APIPassword'] = $config['Sandbox'] ? '7FYW5SWJ5LTTLS7M' : 'QHLTZFMCPRBUH7L7';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AJBT5kSVCpUR400CEzTscG4z4Udz' : 'AesusOdq-zCKPm2WyRH3TlMC3FArATUIsFwvXvWraMuS1mobGwZFpZA6';
