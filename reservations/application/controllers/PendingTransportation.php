    ...
    public function login()
    {
        ...
        if ($_POST && count($_POST) > 0) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                // print_r($this->session->userdata("loginData")['email']);
                $message = "You details are successfully submitted";
            } else {
                $status = 201;
...
//                $message = strip_tags(validation_errors());
    ...
    public function bookingPaymentSuccess() { 
        ...
        $bookid = $info['bookingId'];
        $update = $this->Commonmodel->update_data("booking", array("bookStatus" => "booked", "payStatus" => 'paid'),  array("bookinId", $bookid ));
...
//        $this->load->view('paypal/demos/express_checkout/payment_complete');
    ...
    function BookingCancelled()
    {
        ...
        $this->Commonmodel->update_data("booking", array("bookStatus" => "canceled", "payStatus"=>"canceled"),  array("bookinId", $bookid ));
