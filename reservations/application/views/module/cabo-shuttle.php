            ...
            <div class="row">                  
                <div class="col-md-12  col-xs-12 wow  fadeInRight " data-wow-delay=".3s">
                    <div class="content-inner">
                        ...
                        <P class="">Our services Include:</P>
                        <ul class="">
                            <li>Personalized attention </li>
                            <li>Arrival flight monitoring </li>
                            <li>Reliable and professional costumer service</li>
                            <li>Economical - No Hidden Fees </li>
                            <li>A/C vehicles of recent models </li>
                            <li>No timeshare invitations, only first class service</li>
                        </ul>
                        <p class="">
                            If you are looking for the most reliable Cabo shuttle service from the airport at the reasonable prices, then Inside Los Cabos is the name you can take into consideration. We ensure that each booking is treated in a timely and professional manner so that you keep making us your first choice while travelling. Hence, if you are looking for an accessible airport transportation, just give us a call or you can also make your reservation online in just a few clicks! </p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="">
    ...
    <p class="section-subcontent">You'll then meet your driver, who will help you load your bags, and take you to your hotel in an air/conditioned vehicle, no stops on the way!
        <br>For more information about the airport, please go to <a href="#">Airport Info</a>
    </p>
</section>
...
<!--                                    <select class="form-control"  id="passangers_range" name="info[passengers]" onchange="setCost()">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <button class="btn btn-common apply-coupon-code <?php echo IS_OFFER_HIDE; ?>"  main="1" type="button"><i class="fa fa-gift mr-5"></i>Apply Coupon</button>
